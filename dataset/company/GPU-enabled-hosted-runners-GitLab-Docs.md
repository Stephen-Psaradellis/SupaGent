# GPU-enabled hosted runners | GitLab Docs

Source: https://docs.gitlab.com/ci/runners/hosted_runners/gpu_enabled/
...
GitLab provides GPU-enabled runners only on Linux. For more information about how these runners work, see
...
GPU driver installed. For Nvidia GPUs, you can use their
CUDA Toolkit
.
Example
.gitlab-ci.yml
...
Video demonstration of GitLab GPU-enabled hosted runners:
Train XGboost models with GitLab
.

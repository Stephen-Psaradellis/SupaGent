...
Source: https://docs.gitlab.com/user/get_started/get_started_runner/
...
in your
.gitlab-ci.yml
files to ensure jobs run on runners with the required capabilities.
...
You can configure GitLab Runners by editing the
config.toml
file,

...
Source: https://docs.gitlab.com/ci/pipelines/#configure-a-list-of-selectable-prefilled-variable-values
...
with a flag
named
ci_show_manual_variables_in_pipeline
. Disabled by default.
Generally available
in GitLab 18.4 with a project setting. Feature flag
ci_show_manual_variables_in_pipeline
removed.
...
can have prefilled variables not appear
...
run_pipeline_graphql
removed.
The variables list sometimes did not populate correctly due to
a bug
, which was resolved in GitLab 15.9.

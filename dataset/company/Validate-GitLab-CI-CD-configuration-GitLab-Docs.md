# Validate GitLab CI/CD configuration | GitLab Docs

Source: https://docs.gitlab.com/ci/yaml/lint/
...
You can validate the syntax from a
.gitlab-ci.yml
...
and
rules
configuration. A simulation runs as a Git
push
...
Paste a copy of the CI/CD configuration you want to check into the text box.
Select
Simulate pipeline creation for the default branch
.
Select
Validate
.

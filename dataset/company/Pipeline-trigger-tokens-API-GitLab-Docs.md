...
Source: https://docs.gitlab.com/api/pipeline_triggers/
...
\
--url
"https://gitlab.example.com/api/v4/projects/1/triggers/5"
{
"id"
:
10
...
\
--url
"https://gitlab.example.com/api/v4/projects/1/triggers/10"
{
"id"
:
10
...
ci_inputs_for_pipelines
removed.
Trigger a pipeline by using a
pipeline trigger token
or a
CI/CD job token
for authentication.
With a CI/CD job token, the
triggered pipeline is a multi-project pipeline
.
...
string
Yes
The trigger token or CI/CD job token.
variables
hash
No
A map of key-valued strings containing the pipeline variables. For example:
{ VAR1: "value1", VAR2: "value2" }
.
inputs
hash
No
A map of inputs, as key-value pairs, to use when creating the pipeline.
...
\
--data
'{"inputs": {"environment": "environment", "scan_security": false, "level": 3}}'
\
--url
"https://gitlab.example.com/api/v4/projects/123/trigger/pipeline?token=2cb1840fb9dfc9fb0b7b1609cd29cb&ref=main"
Example response:
...
"sha"
:
"91e2711a93e5d9e8dddfeb6d003b636b25bf6fc9"
,
"ref"
:
"main"
...
"web_url"
:
"http://127.0.0.1:3000/test-group/test-project/-/pipelines/257"
,
"before_sha"
:
...
"details_path"
:
"/test-group/test-project/-/pipelines/257"
,
"illustration"
:
null

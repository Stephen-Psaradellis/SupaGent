# Get started managing code | GitLab Docs

Source: https://docs.gitlab.com/user/get_started/get_started_managing_code/
...
For details, see:
Create a file in the repository from the UI
Open a file in the Web IDE
Create a remote development environment with workspaces
Available editor extensions
Use Code Suggestions to write code more quickly
...
To GitLab, on a remote computer, to the
default branch
.
...
For details, see:
Use Git to create a merge request
Use the UI to create a merge request when you add, edit, or upload a file
...
Request a review of your merge request

# Get started planning work | GitLab Docs

Source: https://docs.gitlab.com/user/get_started/get_started_planning_work/
...
Define your releases by using milestones, like
1.0
,
2.0
, and
3.0
. Decide if you will release both major and minor
releases.
...
Also in comments, you can use mentions (
@username
) to notify others
...
Roadmaps
Time tracking
Milestone burnup and burndown charts
